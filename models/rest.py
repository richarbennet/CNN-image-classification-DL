...
class ResT(nn.Module):  # this model works with any image size, even non-square image size
    def __init__(self, model_name: str = 'S', pretrained: str = None, num_classes: int = 1000, *args, **kwargs) -> None:
        ...
        self.stage3 = nn.ModuleList([
            Block(embed_dims[2], 4, 2, dpr[cur+i])
...
if __name__ == '__main__':
    model = ResT('B', 'checkpoints/rest/rest_base.pth')
